...
class CodeFrequencyVisualizer:
    ...
    def create_dashboard(self, save_dir: Optional[str] = None) -> None:
        ...
        # Net changes
        self.plot_net_changes(
            save_path=str(save_dir / "net_changes.png") if save_dir else None
        )

        # Yearly summary
        self.plot_yearly_summary(
            save_path=str(save_dir / "yearly_summary.png") if save_dir else None
        )

        # Activity heatmap
        self.plot_activity_heatmap(
            save_path=str(save_dir / "activity_heatmap.png") if save_dir else None
        )
