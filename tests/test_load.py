...
def test_get_summary_structure():
    ...
    expected_keys = ['total_additions', 'total_deletions', 'net_changes', 
                     'date_range', 'num_records']
...
def test_summary_calculations():
    ...
    assert isinstance(summary['total_additions'], (int, float)) or hasattr(summary['total_additions'], '__int__')
    assert isinstance(summary['total_deletions'], (int, float)) or hasattr(summary['total_deletions'], '__int__')
    assert isinstance(summary['net_changes'], (int, float)) or hasattr(summary['net_changes'], '__int__')
